...
async.series([
  generateIcons.bind(null, "assets/icon-base-173x173.png", [
    ...
    ["assets/frameworks/ionic.png", "ionic/assets/icons/android/icon-36-ldpi.png", 36],
    ["assets/frameworks/ionic.png", "ionic/assets/icons/android/icon-48-mdpi.png", 48],
    ["assets/frameworks/ionic.png", "ionic/assets/icons/android/icon-72-hdpi.png", 72],
    ["assets/frameworks/ionic.png", "ionic/assets/icons/android/icon-96-xhdpi.png", 96],
    ["assets/frameworks/ionic.png", "ionic/assets/icons/ios/icon-57.png", 57],
    ["assets/frameworks/ionic.png", "ionic/assets/icons/ios/icon-72.png", 72],
    ["assets/frameworks/ionic.png", "ionic/assets/icons/ios/icon-57-2x.png", 114],
    ["assets/frameworks/ionic.png", "ionic/assets/icons/ios/icon-72-2x.png", 144],
    ["assets/frameworks/ionic.png", "ionic/icon.png", 57],
  ...
  generateSplashscreens.bind(null, "assets/splashscreen-bottom-640x640.png", [
    ...
    ["ionic/assets/splashscreens/android/screen-ldpi-portrait.png", 200, 320],
    ["ionic/assets/splashscreens/android/screen-mdpi-portrait.png", 320, 480],
    ["ionic/assets/splashscreens/android/screen-hdpi-portrait.png", 480, 800],
    ["ionic/assets/splashscreens/android/screen-xhdpi-portrait.png", 720, 1280],
    ["ionic/assets/splashscreens/ios/screen-ipad-portrait.png", 768, 1004],
    ["ionic/assets/splashscreens/ios/screen-ipad-portrait-2x.png", 1536, 2008],
    ["ionic/assets/splashscreens/ios/screen-iphone-portrait.png", 320, 480],
    ["ionic/assets/splashscreens/ios/screen-iphone-portrait-2x.png", 640, 960],
    ["ionic/assets/splashscreens/ios/screen-iphone-568h-2x-portrait.png", 640, 1136],
  ]),
